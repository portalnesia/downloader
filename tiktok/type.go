...
type videoData struct {
	...
	CreatedTime    goment.PortalnesiaGoment `json:"-"`
}

func (v *videoData) format() {
	createdint, _ := strconv.ParseInt(v.CreatedTimeStr, 10, 64)
	v.CreatedTime = *goment.Must(createdint)
}
